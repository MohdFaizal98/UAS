  ...
  <body>
    ...
    <div class="container">
      <?php
        ...
        $sql = mysqli_query($conn, "SELECT * FROM makanan"); //script query untuk mengambil semua data dari table transaksi
      ...
      ?>
      <center><h3>Data Pemesanan Makanan <?php echo $row['senarai']; ?> <br>
